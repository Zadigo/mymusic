<template>
  <div v-if="!byGenre" class="list-group">
    <a v-for="i in 4" :key="i" href class="list-group-item list-group-item-action d-flex justify-content-between bg-dark text-light" @click.prevent>
      <span>A song name <font-awesome-icon icon="fa-solid fa-e" class="ms-3" /></span>
